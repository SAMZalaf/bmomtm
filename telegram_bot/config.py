...
class Config:
    ...
    # ========== قاعدة البيانات ==========
    # مسار مطلق لقاعدة البيانات
    DATABASE_FILE: str = os.path.join(os.path.dirname(os.path.abspath(__file__)), "proxy_bot.db")
    
    # ========== NonVoip API Credentials (Legacy - kept for reference) ==========
    NVUEMAIL: str = "Mohamadzalaf2017@gmail.com"
    NVUPASS: str = "sohilSOHIL"
    
    # ========== SMSPool API Credentials ==========
    # Get your API key from: https://www.smspool.net/my/settings
    SMSPOOL_API_KEY: str = "TM8gJdn1mDch9Jup4zbrcNOSyNHMzQNU"
...
معرف الطلب: {order_id}""",
        ...
        'main_menu_buttons': [
            '🔒 طلب بروكسي ستاتيك', '📡 طلب بروكسي سوكس', '🎁 تجربة ستاتيك مجانا',
            '👤 الملف الشخصي', '📋 طلباتي', '⚙️ الإعدادات',
            '📱 أرقام Non-VoIP', '💱 سعر الصرف', '📖 لمحة عن خدماتنا', '🌐 ستاتيك يومي'
        ],
        'profile_menu_buttons': ['ℹ️ معلومات الملف الشخصي', '💰 الملف الشخصي', '👥 الإحالات', '🆘 الدعم', '↩️ رجوع'],
        'profile_menu_title': '👤 ملفي الشخصي\n\nاختر من الخيارات:',
...
© Mohamad Zalaf 2025""",
        ...
        'balance_menu_buttons': ['💳 شحن رصيد', '💰 رصيدي', '↩️ رجوع'],
...
اختر طريقة الدفع للمتابعة:''',
        ...
        'settings_menu_buttons': ['🌐 تغيير اللغة', '🔐 تغيير كلمة المرور', '🔔 إدارة الإشعارات', '📝 تحرير رسالة الخدمات', '💱 تحرير رسالة سعر الصرف', '📜 تعديل رسالة الشروط والأحكام', '🗃️ إدارة قاعدة البيانات', '📢 قناة البوت', '🔙 العودة للقائمة الرئيسية'],
...
Order ID: {order_id}""",
        ...
        'main_menu_buttons': ['🔒 Request Static Proxy', '📡 Request Socks Proxy', '🎁 Free Static Trial', '👤 My Profile', '📋 My Orders', '⚙️ Settings', '📱 Non-VoIP Numbers', '💱 Exchange Rate', '📖 About Our Services', '🌐 Daily Static'],
        'profile_menu_buttons': ['ℹ️ Profile Info', '💰 Balance', '👥 Referrals', '🆘 Support', '↩️ Back'],
...
© Mohamad Zalaf 2025""",
        ...
        'balance_menu_buttons': ['💳 Recharge Balance', '💰 My Balance', '↩️ Back'],
...
Choose payment method to continue:''',
        ...
        'settings_menu_buttons': ['🌐 Change Language', '🔐 Change Password', '🔔 Manage Notifications', '📝 Edit Services Message', '💱 Edit Exchange Rate Message', '📜 Edit Terms and Conditions', '🗃️ Database Management', '📢 Bot Channel', '🔙 Back to Main Menu'],
