...
"""
============================================
📍 ملف الإعدادات للسيرفر - config_server.py
============================================
نسخة مخصصة للتشغيل على السيرفر الخارجي
Server: 162.19.199.122:56777
...
from telegram import Update, InlineKeyboardButton, InlineKeyboardM
arkup
...
class Config:
    ...
    # ========== رابط واجهة الويب ==========
    # الوصول المباشر على Port 5000
    WEBAPP_URL: str = "http://162.19.199.122:5000"

    # ========== رابط التطبيق المصغر (Mini App) - اختياري ========
==
    # للـ Mini App في Telegram تحتاج HTTPS (دومين + SSL)
    MINIAPP_URL: str = "http://162.19.199.122:5000"
...
WEBAPP_URL = Config.WEBAPP_URL  # رابط واجهة الويب
...
US_STATE_AREA_CODES = {
    'California': ['209', '213', '279', '310', '323', '408', '415'
, '424', '442', '510', '530', '559', '562', '619', '626', '628', '
650', '657', '661', '669', '707', '714', '747', '760', '805', '818
', '831', '858', '909', '916', '925', '949', '951'],
    'Texas': ['210', '214', '254', '281', '325', '346', '361', '40
9', '430', '432', '469', '512', '682', '713', '726', '737', '806',
 '817', '830', '832', '903', '915', '936', '940', '956', '972', '9
79'],
    'New York': ['212', '315', '332', '347', '516', '518', '585', 
'607', '631', '646', '680', '716', '718', '838', '845', '914', '91
7', '929', '934'],
    'Florida': ['239', '305', '321', '352', '386', '407', '561', '
727', '754', '772', '786', '813', '850', '863', '904', '941', '954
'],
    'Illinois': ['217', '224', '309', '312', '331', '618', '630', 
'708', '773', '779', '815', '847', '872'],
    'Pennsylvania': ['215', '223', '267', '272', '412', '445', '48
4', '570', '582', '610', '717', '724', '814', '878'],
    'Ohio': ['216', '220', '234', '330', '380', '419', '440', '513
', '567', '614', '740', '937'],
    'Georgia': ['229', '404', '470', '478', '678', '706', '762', '
770', '912'],
    'North Carolina': ['252', '336', '704', '743', '828', '910', '
919', '980', '984'],
    'Michigan': ['231', '248', '269', '313', '517', '586', '616', 
'734', '810', '906', '947', '989'],
    'New Jersey': ['201', '551', '609', '640', '732', '848', '856'
, '862', '908', '973'],
    'Virginia': ['276', '434', '540', '571', '703', '757', '804'],
    'Washington': ['206', '253', '360', '425', '509', '564'],
    'Arizona': ['480', '520', '602', '623', '928'],
    'Massachusetts': ['339', '351', '413', '508', '617', '774', '7
81', '857', '978'],
...
لجة الطلب يدوياً من الأدمن بأقرب وقت.\n\n📧 ستصلك تحديثات الحالة تل
قائياً.',
        'main_menu_buttons': ['🔒 طلب بروكسي ستاتيك', '📡 طلب بروك
سي سوكس', '🎁 تجربة ستاتيك مجانا', '💰 الرصيد', '📋 طلباتي', '⚙️ ال
إعدادات', '📱 أرقام Non-VoIP', '💱 سعر الصرف', '📖 لمحة عن خدماتنا
'],
        'admin_main_buttons': ['📋 إدارة الطلبات', '💰 إدارة الأمو
ال', '👥 الإحالات', '📢 البث', '⚙️ الإعدادات'],
        'change_password': 'تغيير كلمة المرور',
        'password_changed': 'تم تغيير كلمة المرور بنجاح ✅',
        'invalid_password': 'كلمة المرور غير صحيحة!',
        'enter_new_password': 'يرجى إدخال كلمة المرور الجديدة:',
        'withdrawal_processing': 'جاري معالجة طلب سحب رصيدك من قبل
 الأدمن...',
        'admin_contact': 'ستتواصل الإدارة معك قريباً لتسليمك مكافأت
ك.',
        'language_change_success': 'تم تغيير اللغة إلى العربية ✅\
nيرجى استخدام الأمر /start لإعادة تحميل القوائم',
...
...',
        'order_success': '✅ تم إنجاز طلبك بنجاح! تم إرسال تفاصيل 
البروكسي إليك.',
        'order_failed': '❌ تم رفض طلبك. يرجى التحقق من إثبات الدف
ع والمحاولة مرة أخرى.',
        'about_bot': """🤖 حول البوت
...
جب أن يكون رقماً صحيحاً بين 1 و 99\n\nمثال: 5',
        'invalid_quantity': '❌ عدد غير صحيح!\n\n🔢 يرجى إدخال رقم
 صحيح بين 1 و 99 فقط\n❌ لا تستخدم فواصل أو نصوص\n\nمثال صحيح: 5\n
مثال خاطئ: 2.5 أو خمسة',
        'services_info': 'هذه رسالة الخدمات الافتراضية. يمكن للإدا
رة تعديلها.',
        'balance_menu_buttons': ['💳 شحن رصيد', '💰 رصيدي', '👥 ال
إحالات', '↩️ العودة للقائمة الرئيسية'],
...
اختر طريقة الدفع للمتابعة:''',
        'enter_recharge_amount': '💎 أدخل قيمة المبلغ المراد شحنه 
بالدولار:\n\nمثال: 10',
        'invalid_recharge_amount': '❌ قيمة غير صحيحة! يرجى إدخال 
رقم صحيح أكبر من 0',
        'recharge_proof_request': 'يرجى إرسال إثبات الدفع (صورة فق
ط):',
        'recharge_order_created': '✅ تم إنشاء طلب شحن الرصيد بنجا
ح!\n\n🆔 معرف الطلب: {order_id}\n💰 المبلغ: ${amount:.2f}\n💎 الكر
يديتات المتوقعة: {points:.2f} كريديت\n\n📋 سيقوم الأدمن بمراجعة ال
طلب',
        'orders_menu_title': '📋 إدارة الطلبات\nاختر العملية المطل
وبة:',
        'orders_menu_buttons': ['📋 الطلبات المعلقة', '🔍 استعلام 
عن طلب', '🗑️ حذف الطلبات المعالجة', '🗑️ حذف جميع الطلبات', '🔙 العود
ة للقائمة الرئيسية'],
        'money_menu_title': '💰 إدارة الأموال\nاختر العملية المطلو
بة:',
        'money_menu_buttons': ['📊 إحصائيات المبيعات', '📱 إحصائيا
ت NonVoipUsNumber', '💲 إدارة الأسعار', '🔙 العودة للقائمة الرئيسي
ة'],
        'referrals_menu_title': '👥 الإحالات\nاختر العملية المطلوب
ة:',
        'referrals_menu_buttons': ['💵 تحديد مبلغ الإحالة', '📊 إح
صائيات المستخدمين', '🗑️ إعادة تعيين رصيد المستخدم', '🔙 العودة للقا
ئمة الرئيسية'],
        'settings_menu_title': '⚙️ الإعدادات\nاختر العملية المطلوبة
:',
        'settings_menu_buttons': ['🌐 تغيير اللغة', '🔐 تغيير كلمة
 المرور', '🔔 إدارة الإشعارات', '📝 تحرير رسالة الخدمات', '💱 تحري
ر رسالة سعر الصرف', '📜 تعديل رسالة الشروط والأحكام', '🗃️ إدارة قاع
دة البيانات', '🔙 العودة للقائمة الرئيسية'],
...
Order ID: {order_id}""",
        ...
        'send_payment_proof': 'Please send payment proof (image on
ly):',
        'order_received': '✅ Your order has been received success
fully!\n\n📋 Admin will process it manually soon.\n\n📧 You will r
eceive status updates automatically.',
        'main_menu_buttons': ['🔒 Request Static Proxy', '📡 Reque
st Socks Proxy', '🎁 Free Static Trial', '💰 Balance', '📋 My Orde
rs', '⚙️ Settings', '📱 Non-VoIP Numbers', '💱 Exchange Rate', '📖 
About Our Services'],
        'admin_main_buttons': ['📋 Manage Orders', '💰 Manage Mone
y', '👥 Referrals', '📢 Broadcast', '⚙️ Settings'],
        'change_password': 'Change Password',
        'password_changed': 'Password changed successfully ✅',
        'invalid_password': 'Invalid password!',
        'enter_new_password': 'Please enter new password:',
        'withdrawal_processing': 'Your withdrawal request is being
 processed by admin...',
        'admin_contact': 'Admin will contact you soon to deliver y
our reward.',
...
\nPlease use /start command to reload menus',
        ...
        'order_processing': '⚙️ Your order is now being processed b
y admin...',
        'order_success': '✅ Your order has been completed success
fully! Proxy details have been sent to you.',
        'order_failed': '❌ Your order has been rejected. Please c
heck your payment proof and try again.',
        'about_bot': """🤖 About Bot
...
\n📝 Must be a whole number between 1 and 99\n\nExample: 5',
 ...
 a whole number between 1 and 99 only\n❌ Don\'t use decimals or t
ext\n\nCorrect example: 5\nWrong example: 2.5 or five',
        'services_info': 'This is the default services message. Ad
min can modify it.',
        'balance_menu_buttons': ['💳 Recharge Balance', '💰 My Bal
ance', '👥 Referrals', '↩️ Back to Main Menu'],
...
Choose payment method to continue:''',
        'enter_recharge_amount': '💎 Enter the amount to recharge 
in USD:\n\nExample: 10',
        'invalid_recharge_amount': '❌ Invalid amount! Please ente
r a valid number greater than 0',
        'recharge_proof_request': 'Please send payment proof (imag
e only):',
        'recharge_order_created': '✅ Balance recharge request cre
ated successfully!\n\n🆔 Order ID: {order_id}\n💰 Amount: ${amount
:.2f}\n💎 Expected Credits: {points:.2f} credits\n\n📋 Admin will 
review the request',
        'orders_menu_title': '📋 Manage Orders\nChoose the require
d operation:',
        'orders_menu_buttons': ['📋 Pending Orders', '🔍 Order Inq
uiry', '🗑️ Delete Processed Orders', '🗑️ Delete All Orders', '🔙 Bac
k to Main Menu'],
        'money_menu_title': '💰 Manage Finances\nChoose the requir
ed operation:',
        'money_menu_buttons': ['📊 Sales Statistics', '📱 NonVoipU
sNumber Statistics', '💲 Manage Prices', '🔙 Back to Main Menu'],
        'referrals_menu_title': '👥 Referrals\nChoose the required
 operation:',
        'referrals_menu_buttons': ['💵 Set Referral Amount', '📊 U
ser Statistics', '🗑️ Reset User Balance', '🔙 Back to Main Menu'],
        'settings_menu_title': '⚙️ Settings\nChoose the required op
eration:',
        'settings_menu_buttons': ['🌐 Change Language', '🔐 Change
 Password', '🔔 Manage Notifications', '📝 Edit Services Message',
 '💱 Edit Exchange Rate Message', '📜 Edit Terms and Conditions', 
'🗃️ Database Management', '🔙 Back to Main Menu'],
...
🎯 **Quality:** We provide the best SOCKS at the lowest market pri
ces!""",
            4
        ),
        (
...
Contact us via commands in /help""",
 ...
 display_order)
    ...
    conn.commit()
    conn.close()
    logger.info(f"✅ تم إدراج {len(faq_data)} سؤال في قاعدة البيان
ات")
...
def get_faq_questions(language: str = 'ar') -> List[Tuple[int, str
    ...
    try:
        ...
        question_col = 'question_ar' if language == 'ar' else 'que
stion_en'
        cursor.execute(f"SELECT id, {question_col} FROM faq_conten
t ORDER BY display_order")
...
def get_faq_answer(faq_id: int, language: str = 'ar') -> Optional[
str]:
    """جلب إجابة سؤال معين"""
    try:
        conn = sqlite3.connect(DATABASE_FILE)
        ...
        answer_col = 'answer_ar' if language == 'ar' else 'answer_
en'
        cursor.execute(f"SELECT {answer_col} FROM faq_content WHER
E id = ?", (faq_id,))
...
async def show_faq_menu(update: Update, context: ContextTypes.DEFA
ULT_TYPE):
    ...
    for faq_id, question in questions:
        keyboard.append([InlineKeyboardButton(question, callback_d
ata=f"faq_{faq_id}")])
...
="back_to_main")])
    ...
    subtitle = "اختر سؤالاً للاطلاع على الإجابة:" if language == 'a
r' else "Choose a question to see the answer:"
...
async def handle_faq_callback(update: Update, context: ContextType
s.DEFAULT_TYPE):
    ...
    if answer:
        back_text = "🔙 العودة للأسئلة" if language == 'ar' else "
🔙 Back to FAQ"
...
="show_faq")]]
        ...
        error_text = "❌ عذراً، لم يتم العثور على الإجابة." if lang
uage == 'ar' else "❌ Sorry, answer not found."
...
def get_country_name(country_code: str, language: str = 'ar', prox
y_type: str = 'static') -> str:
    ...
    return countries.get(language, {}).get(country_code, country_c
ode)


def get_state_name(state_code: str, language: str = 'ar', country:
 str = 'US') -> str:
